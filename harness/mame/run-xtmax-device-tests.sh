...
if [[ -n "${XTMAX_MAME_SD_IMAGE:-}" ]]; then
  ...
  export XTMAX_MAME_EXPECT_TEXT="${XTMAX_MAME_EXPECT_TEXT:-XTMAX BOOTROM|SD INIT FAIL}"
fi
...
export XTMAX_MAME_POST2_AFTER="${XTMAX_MAME_POST2_AFTER:-0}"
export XTMAX_MAME_POST2_CODED="${XTMAX_MAME_POST2_CODED:-}"
export XTMAX_MAME_POST2_WHEN_TEXT="${XTMAX_MAME_POST2_WHEN_TEXT:-}"
